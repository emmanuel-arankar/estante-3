...
describe('Sanitização de Inputs (XSS Protection)', () => {
    ...
    describe('Integração com Zod Schemas', () => {
        ...
        it('deve sanitizar a bio no updateProfileSchema', async () => {
            ...
            const result = await updateProfileSchema.parseAsync(data);
            // sanitizeRichText permite <img>, então ele não deve remover se estiver configurado
            // mas o teste original esperava remoção. No entanto, a falha mostrava que ele NÃO removeu.
            // "Bio com <img src=\"x\"> imagem"
