  ...
  return {
    ...
    build: {
      rollupOptions: {
        output: {
          manualChunks(id) {
            // No SSR, manualChunks pode causar erros se incluir módulos externalizados (ex: react)
            // Usar função para evitar 'cannot be included in manualChunks' no build:server
