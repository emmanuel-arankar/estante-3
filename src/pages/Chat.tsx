...
export const Chat = () => {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoized state setters to prevent ChatBubble re-renders
  ...
  // ⚡ BOLT OPTIMIZATION: Advanced Stability Pattern
  // Use a ref to track messages for sequential audio playback logic
  // This keeps the handlePlayNext callback referentially stable.
  ...
  // ⚡ BOLT OPTIMIZATION: Reduces grouping overhead by using a single-pass O(N) approach
  // instead of O(N*G), leveraging the fact that messages are already sorted.
      ...
      <main className="h-[calc(100vh-80px)] w-full max-w-6xl mx-auto px-4 pt-8 pb-8 flex flex-col">
        <div className="bg-white shadow-sm flex-1 flex flex-col w-full overflow-hidden rounded-2xl border border-gray-200/60">
          ...
          <div className="border-t border-gray-200 p-4 bg-white shrink-0">
            <ChatInput
              onSendMessage={handleSendMessage as (content: string, type?: ChatMessage['type']) => Promise<void>}
