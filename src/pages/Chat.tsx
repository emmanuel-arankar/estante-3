...
export const Chat = () => {
  ...
  // ⚡ BOLT OPTIMIZATION: Stable reference to prevent unnecessary effect re-runs
  ...
  const handleSendMessage = async (
    ...
    await sendMessage(content, type as 'text' | 'audio' | 'image', isTemporary, file, waveform, duration, caption, viewOnce, images);
  };
  ...
  // ⚡ BOLT OPTIMIZATION: O(N) grouping logic by leveraging chronological order.
  // This avoids the O(N * G) overhead of .find() within the message loop.
