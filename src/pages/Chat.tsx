...
export const Chat = () => {
  ...
  // Use a ref for messages to keep the handlePlayNext stable
  ...
  // ⚡ BOLT OPTIMIZATION: Single-pass O(N) grouping
  // Messages are already sorted chronologically from the service.
  // This avoids O(N*G) complexity of searching through groups for every message.
