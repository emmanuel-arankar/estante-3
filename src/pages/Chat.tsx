...
export const Chat = () => {
  ...
  }, [searchQuery, searchMatches.length, scrollToMessage, searchMatches]);

  // ⚡ BOLT OPTIMIZATION: Stable handlers to prevent ChatBubble re-renders
  ...
  // ⚡ BOLT OPTIMIZATION: O(N) single-pass grouping for chronologically sorted messages
