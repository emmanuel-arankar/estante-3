...
export const Chat = () => {
  ...
  }, [searchQuery, scrollToMessage, searchMatches]);

  // Agrupa mensagens por data (não mais filtrado por busca)
  // ⚡ BOLT OPTIMIZATION: Reduces grouping overhead from O(N*G) to O(N) by checking only the tail of the groups array,
  // since messages are chronologically sorted.
