...
export const Chat = () => {
  ...
  // Bolt: Advanced Stability Pattern - keep messages ref for callbacks
  ...
  const handleEdit = useCallback((message: ChatMessage | null) => {
    setReplyingTo(null);
  ...
  const handlePlayNext = useCallback((currentMessageId: string) => {
    // Bolt: Use ref to avoid dependency on messages array
  ...
  // Bolt: Optimized for O(N) by leveraging sorted order of messages
