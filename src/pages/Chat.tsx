...
export const Chat = () => {
  ...
  // Sync messagesRef for stable callbacks
  useEffect(() => {
  ...
  // O(N) optimized grouping: as messages are already sorted by date,
  // we only need to compare the current message with the last group created.
