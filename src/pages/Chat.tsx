...
export const Chat = () => {
  ...
  // ⚡ BOLT OPTIMIZATION: Usar ref para manter handlePlayNext estável mesmo quando messages muda
  ...
  // ⚡ BOLT OPTIMIZATION: Callbacks estáveis para evitar re-renders do ChatBubble (memoizado)
  ...
  // ⚡ BOLT OPTIMIZATION: Reduz complexidade de O(N*G) para O(N) aproveitando a ordenação cronológica.
  // Evita buscas repetidas no array de grupos já que as mensagens chegam ordenadas.
      ...
      <main className="h-[calc(100vh-80px)] w-full max-w-6xl mx-auto px-4 pt-8 pb-8 flex flex-col">
        <div className="bg-white shadow-sm flex-1 flex flex-col w-full overflow-hidden rounded-2xl border border-gray-200/60">
          ...
          <div className="border-t border-gray-200 p-4 bg-white shrink-0">
            <ChatInput
              onSendMessage={handleSendMessage as (
                content: string,
