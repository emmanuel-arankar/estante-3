...
export const useNotifications = () => {
    ...
    // PERFORMANCE: Memoize the derived array of notifications to prevent
    // redundant re-renders of consuming components since flatMap creates a new array reference every render.
