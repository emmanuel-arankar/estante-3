...
export const useNotifications = () => {
    ...
    // PERFORMANCE: Memoize flattened notifications array to maintain stable array reference equality.
    // Prevents redundant re-renders and unnecessary re-evaluations of downstream memoized hooks/components (e.g. NotificationsPage, NotificationDropdown).
