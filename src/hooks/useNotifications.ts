...
export const useNotifications = () => {
    ...
    // PERFORMANCE: Memoize notifications array derivation to preserve reference stability
    // across re-renders (e.g. unreadQuery polling updates or parent re-renders).
