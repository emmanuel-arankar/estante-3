...
export const useNotifications = () => {
    ...
    // PERFORMANCE: Memoize the derived notifications array.
    // Since notificationsQuery has polling/updates, wrapping the flatMap in useMemo
    // prevents unnecessary array reference changes on every render.
