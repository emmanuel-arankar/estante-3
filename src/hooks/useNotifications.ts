...
export const useNotifications = () => {
    ...
    // PERFORMANCE: Memoize notifications array to prevent breaking downstream memoization/useMemos
    // during polling (unreadQuery) or when other unrelated states of the parent component trigger renders.
