...
/**
 * Componente de fundo animado isolado e memoizado.
 * O uso de useMemo para as partículas garante que elas não "saltem"
 * se o componente pai for re-renderizado por qualquer motivo.
 */
...
/**
 * Componente de busca isolado para evitar re-renders do componente Hero
 * em cada tecla digitada (onchange do input).
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      {/* ⚡ Bolt: Background isolado e memoizado para evitar saltos visuais e custos de render */}
      <HeroBackground />
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* ⚡ Bolt: SearchBar isolada evita re-renderizar todo o Hero (incluindo background e stats) no onChange */}
          <HeroSearchBar />
