...
/**
 * Sub-componente para o fundo animado.
 * Memoizado para evitar re-renderizações desnecessárias.
 * Usa useMemo para estabilizar as propriedades aleatórias dos círculos,
 * eliminando o "jitter" visual quando o estado do componente pai muda.
 */
...
/**
 * Sub-componente para a barra de busca.
 * Isola o estado 'searchQuery' para que a digitação não provoque
 * a re-renderização de todo o Hero ou das animações de fundo.
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      {/* Fundo animado agora é um componente separado e otimizado */}
      <HeroBackground />
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Barra de busca isolada para performance */}
          <HeroSearchBar />
