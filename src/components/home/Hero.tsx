...
export const Hero = () => {
  // ⚡ Performance Optimization: Stabilize background dots to prevent visual jitter on re-renders
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          >
            {/* ⚡ Performance Optimization: Isolated search bar state to prevent
                full component re-renders (including animated background) on every keystroke */}
            <HeroSearchBar />
          </motion.div>
