...
/**
 * Isolated Search Bar component to prevent parent Hero component (with heavy animations)
 * from re-rendering on every keystroke.
 */
const HeroSearchBar = React.memo(() => {
...
export const Hero = () => {
  // Memoize background element properties to prevent visual jitter and redundant
  // Math.random() calls during component re-renders.
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - Isolated to prevent full-component re-renders */}
          <HeroSearchBar />
