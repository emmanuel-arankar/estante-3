...
/**
 * Componente isolado para a barra de busca para evitar re-renders do componente pai
 * em cada tecla digitada (o que causaria jitter nas animações de fundo se não estivessem memoizadas)
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  // Memoizamos as propriedades aleatórias dos pontos de fundo para evitar visual jitter
  // e cálculos desnecessários durante re-renders (como ao abrir o menu ou mudar estado global)
  const dots = useMemo(() => {
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - Agora isolado para performance */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
