...
// Sub-component for isolated search state
// This prevents the entire Hero component (and background animation) from re-rendering on every keystroke
const HeroSearchBar = () => {
...
// Memoized background to prevent re-renders when parent re-renders
const HeroBackground = React.memo(() => {
  // Stabilize random values to prevent visual jitter and redundant calculations
  // these values are only calculated once on mount
...
export const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      {/* Animated background elements - Isolated in memoized component */}
      <HeroBackground />
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - Isolated state prevents background re-renders on keystroke */}
          <HeroSearchBar />
