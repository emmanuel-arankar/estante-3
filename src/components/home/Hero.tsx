...
/**
 * Componente que renderiza os elementos flutuantes do fundo.
 * Memoizado para evitar re-renderizações desnecessárias quando o estado de busca muda.
 */
const HeroBackground = React.memo(() => {
  // ✅ Estabilizar as propriedades aleatórias para evitar que as partículas "saltem" no re-render
...
/**
 * Componente isolado para a barra de busca.
 * Evita que o componente pai (Hero) re-renderize a cada tecla pressionada.
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      {/* Background animado e memoizado */}
      <HeroBackground />
