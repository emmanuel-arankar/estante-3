...
/**
 * SearchBar component extracted to localize the searchQuery state.
 * This prevents the entire Hero component (including animations and stats)
...
export const Hero = () => {
  // Memoize background elements to prevent visual jitter and redundant Math.random() calls on re-renders
