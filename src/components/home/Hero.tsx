...
export const Hero = () => {
  ...
  // Performance: Memoize background elements to prevent re-generation on every keystroke in search bar.
  // This saves ~80 Math.random() calls per render and prevents visual layout shifts of the dots.
