...
/**
 * SearchBar component extracted to isolate search state and prevent
 * re-rendering the entire Hero component (and its animations) on every keystroke.
 */
const SearchBar = () => {
...
export const Hero = () => {
  // Memoize background elements to prevent visual jitter and redundant
