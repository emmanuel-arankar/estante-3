...
/**
 * Optimized search bar component that isolates state re-renders.
 * Prevents the parent Hero component from re-rendering on every keystroke.
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  /**
   * Memoize background particle properties to prevent visual jitter and
   * redundant calculations during re-renders.
   * Stabilization reduces CPU usage for Framer Motion calculations.
   */
