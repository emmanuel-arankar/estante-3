...
/**
 * Standalone SearchBar component to prevent Hero from re-rendering on every keystroke.
 * This isolates the local state of the search query.
 */
const SearchBar = () => {
...
export const Hero = () => {
  /**
   * Stabilize background dots properties to prevent visual jitter and redundant
   * Math.random() calls on every re-render.
   */
  const dots = useMemo(() => {
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - Extracted to prevent full Hero re-renders */}
          <SearchBar />
