...
export const Hero = () => {
  ...
  // ⚡ Optimization: Stabilize background animation parameters.
  // This prevents Math.random() from being re-executed on every keystroke in the search bar,
  // avoiding O(N) calculations and visual jitter during state-triggered re-renders.
