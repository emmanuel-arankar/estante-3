...
/**
 * PERFORMANCE: Memoized background to prevent re-renders on search input.
 * Also uses useMemo to stabilize random positions, avoiding jitter during re-renders.
 */
...
/**
 * PERFORMANCE: Isolated search state into its own component.
 * Prevents the entire Hero section from re-rendering on every keystroke.
 */
const HeroSearch = () => {
