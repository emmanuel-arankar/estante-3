...
export const Hero = () => {
  ...
  // PERFORMANCE: Stable animation coordinates, durations, and delays.
  // Using Math.random() in the render path causes visual jitter of background elements
  // and layout recalculations whenever the user types in the search input (causing component re-renders).
