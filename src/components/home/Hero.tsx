...
/**
 * Isolated search bar component to prevent re-rendering the entire Hero
 * background animations on every keystroke.
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  // Stabilize random values for background dots to prevent jitter on re-renders.
  // Although state is isolated now, useMemo ensures visual stability if parent re-renders.
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - isolated component to reduce re-render impact */}
          <HeroSearchBar />
