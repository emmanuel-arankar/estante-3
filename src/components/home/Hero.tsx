...
export const Hero = () => {
  ...
  /**
   * PERFORMANCE OPTIMIZATION: Memoize the random coordinates, durations, and delays
   * of the background bubbles. Generating these on each render causes visual jitter,
   * animation resets on typing (keystrokes re-render), and unnecessary re-calculations.
   */
