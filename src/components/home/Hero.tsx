...
/**
 * Optimized Search Bar component to localize state and prevent full Hero re-renders.
 */
const HeroSearchBar = () => {
...
export const Hero = () => {
  // Memoize particle properties to prevent background jitter on re-renders
    ...
    <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white overflow-hidden min-h-[calc(100vh-5rem)] flex items-center">
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* Search Bar - Extracted to prevent re-rendering Hero on keystrokes */}
          <HeroSearchBar />
