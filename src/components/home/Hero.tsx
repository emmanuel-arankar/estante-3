...
// Performance Optimization: Stabilize random background elements to prevent visual jitter
// and wrap in React.memo to prevent re-renders when parent state (search) changes.
...
// Performance Optimization: Isolate search state to its own component
// to prevent parent Hero component re-renders on every keystroke.
const HeroSearchBar = () => {
