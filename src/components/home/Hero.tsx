...
export const Hero = () => {
  ...
  // Memoize background dots to prevent jitter on re-renders (e.g. during search typing)
  // This avoids O(N) random calculations and layout shifts on every keystroke
