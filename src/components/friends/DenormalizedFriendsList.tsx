...
// Componente para mostrar amigos em comum com avatar group e tooltip (memoizado para evitar re-renders desnecessários)
const MutualFriendsIndicator = React.memo<
  { userId: string; friendId: string; count: number }
...
// Componente auxiliar para calcular amigos em comum dinamicamente (memoizado)
const DynamicMutualFriendsIndicator = React.memo<
...
// # atualizado: FriendCard com PrefetchLink e amigos em comum (memoizado)
const FriendCard = React.memo(
  React.forwardRef<HTMLDivElement, { friendship: DenormalizedFriendship; userId: string; onAction: (id: string) => void }>(
...
// # atualizado: RequestCard com PrefetchLink, amigos em comum sempre dinâmico (memoizado)
// Para solicitações pendentes, sempre buscamos dinamicamente para garantir precisão
const RequestCard = React.memo(
  React.forwardRef<HTMLDivElement, { friendship: DenormalizedFriendship; userId: string; onAccept: (id: string) => void; onReject: (id: string) => void }>(
...
// # atualizado: SentRequestCard com PrefetchLink, amigos em comum sempre dinâmico (memoizado)
// Para solicitações pendentes, sempre buscamos dinamicamente para garantir precisão
const SentRequestCard = React.memo(
  React.forwardRef<HTMLDivElement, { friendship: DenormalizedFriendship; userId: string; onCancel: (id: string) => void }>(
...
// # atualizado: FriendListItem com PrefetchLink e amigos em comum (memoizado)
...
// # atualizado: RequestListItem com PrefetchLink, amigos em comum e tooltip (memoizado)
...
// # atualizado: SentRequestListItem com PrefetchLink, amigos em comum e tooltip (memoizado)
