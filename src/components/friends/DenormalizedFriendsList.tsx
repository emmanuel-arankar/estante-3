 ...
 * PERFORMANCE: Memoizado para evitar re-renders durante a busca na lista.
 */
const MutualFriendsIndicator = React.memo<({ userId, friendId, count }: { userId: string; friendId: string; count: number }) => React.ReactNode>(({ userId, friendId, count }) => {
 ...
 * PERFORMANCE: Memoizado e usa Intersection Observer para lazy loading de contadores.
 */
 ...
 * PERFORMANCE: Memoizado para evitar re-renders da grade durante digitação no campo de busca.
 */
 ...
 * PERFORMANCE: Memoizado para reduzir carga de renderização em listas de solicitações.
 */
 ...
 * PERFORMANCE: Memoizado para garantir estabilidade visual durante operações em lote.
 */
