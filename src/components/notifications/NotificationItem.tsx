...
/**
 * PERFORMANCE: Memoized using React.memo to prevent redundant re-renders
 * of individual notification items when other parts of the list or parent component update.
 */
