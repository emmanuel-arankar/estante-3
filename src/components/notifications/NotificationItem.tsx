...
/**
 * PERFORMANCE: Memoized to prevent unnecessary re-renders when parent list components
 * (such as NotificationDropdown or Notifications page) re-render or update state.
 */
