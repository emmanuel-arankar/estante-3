...
/**
 * PERFORMANCE: Memoized to prevent unnecessary re-renders when parent notification list,
 * filter tabs, or unread counter update, unless the notification prop or onMarkAsRead changes.
 */
