...
// PERFORMANCE: Memoize NotificationItem to prevent redundant re-renders of list items
// inside NotificationDropdown or NotificationsPage when other elements update.
