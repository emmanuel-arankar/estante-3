...
export const NotificationDropdown = () => {
    ...
    // PERFORMANCE: Memoize the sliced subset of notifications to ensure a stable array reference
    // is passed to map(), preventing child component re-renders unless the list changes.
