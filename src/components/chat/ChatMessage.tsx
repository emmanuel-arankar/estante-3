...
// ⚡ BOLT OPTIMIZATION: Hoisted constants to avoid re-allocation
...
// ⚡ BOLT OPTIMIZATION: memoized component to prevent re-renders when parent state (e.g. typing) changes
